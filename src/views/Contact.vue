	...
	<v-card class="mx-auto">
					...
					<v-expansion-panels>
						<v-expansion-panel>
							<v-expansion-panel-header
								>PGP ID</v-expansion-panel-header
							>
		...
		<v-list-item class="item">
			...
			<v-list-item-content>
				<v-list-item-title class="item-content">
					Hi 👋, I'm sp1rit.<br />
					I mainly do higher level Rust development and RPM packaging,
					but also ECMA and EDK2 stuff.<br />
					<br />
		...
		<v-list two-line>
			<v-list-item @click="openURI(`https://sp1ritCS.github.io/me`)">
				...
				<v-list-item-content>
					<v-list-item-title
						>https://sp1ritCS.github.io/me</v-list-item-title
					>
			...
			<v-divider inset />
			<v-list-item
				@click="openURI(`https://social.privacytools.io/@sp1rit`)"
			>
				<v-list-item-icon>
				...
				<v-list-item-content>
					<v-list-item-title
						>@sp1rit@social.privacytools.io</v-list-item-title
					>
			...
			<v-divider inset />
			<v-list-item
				@click="openURI(`https://matrix.to/#/@sp1rit:tchncs.de`)"
			>
				<v-list-item-icon>
			...
			<v-list-item
				@click="openURI(`https://matrix.to/#/@sp1rit:opensuse.org`)"
			>
				...
				<v-list-item-content>
					...
					<v-list-item-subtitle
						>Matrix - Fallback</v-list-item-subtitle
					>
				</v-list-item-content>
			</v-list-item>
			<v-divider inset />
			...
			<v-list-item @click="openKeyDiag(0)">
				...
				<v-list-item-content>
					<v-list-item-title
						>c3Axcml0QGRpc3Jvb3Qub3JnCg==</v-list-item-title
					>
					<v-list-item-subtitle>
			...
			<v-list-item @click="openKeyDiag(1)">
				...
				<v-list-item-content>
					<v-list-item-title
						>sp1ritCS&#64;protonmail.com</v-list-item-title
					>
					<v-list-item-subtitle
			...
			<v-list-item>
				...
				<v-list-item-content>
					...
					<v-list-item-subtitle
						>Spoken Languages</v-list-item-subtitle
					>
				</v-list-item-content>
			</v-list-item>
		</v-list>
